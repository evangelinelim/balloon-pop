...
async function createNodeFullStack(CURR_DIR, projectName) {
  return new Promise((resolve, reject)=>{
    try {
      ...
      execSync("node " + `"${__dirname}/../node_modules/create-project" ${projectName} codeworks-templates/node-server-auth0`);
